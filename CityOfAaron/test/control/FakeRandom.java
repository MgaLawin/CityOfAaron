...
/**
 *
 * @author DIDIM Trying out the fake random for testing.
 */
...
// add the specified integer value to the list of values that will be returned by the nextInv() method
    ...
    /**
     * returns the next predetermined value from the list or -1 if these are no
     * more predetermined values to be returned
     */
    @Override
