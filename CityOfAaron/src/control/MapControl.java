...
public class MapControl {
    ...
    public static Map createMap (){
        ...
        Location[][] locations = new Location[noOfRows][noOfColumns];
            ...
            locations[2][0] = new Location("R", "River", "fill in a You are standing next to the river that    flows through the City of Aaron. You use this river to irrigate your wheat fields. ", new String[]{});
            locations[2][1] = new Location("R", "River", "fill in a You are standing next to the river that flows through the City of Aaron. You use this river to irrigate your wheat fields. ", new String[]{});
            locations[2][2] = new Location("R", "River", "fill in a You are standing next to the river that flows through the City of Aaron. You use this river to irrigate your wheat fields. ", new String[]{});
            ...
            locations[3][3] = new Location("R", "River", "fill in a You are standing next to the river that flows through the City of Aaron. You use this river to irrigate your wheat fields. ", new String[]{});
            ...
            locations[4][2] = new Location("R", "River", "fill in a You are standing next to the river that flows through the City of Aaron. You use this river to irrigate your wheat fields. ", new String[]{});
            locations[4][3] = new Location("U", "Undeveloped Land", "You are staining on undeveloped land.",                    new String[]{});
