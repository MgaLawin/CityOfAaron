...
public class SaveGameView extends ViewBase {
     ...
     * Constructor
     *
     * The program will prompt the user for where the file should be saved
     * if the game state is saved to a file, the computer will display a success- not working yet- will stub
     * if the game state is not saved the program will throw and error
     * Then the computer will return to the main menu
     *
     */
